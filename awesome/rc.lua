...
function getBatteryStatus()
   local fd= io.popen("/home/jim/tools/battery.sh")
...
browser = "google-chrome --disable-web-security --pinned-tab-count=6"
browser_debug = "google-chrome --disable-web-security"
lock = "xtrlock"
...
-- Brightness
    ...
    awful.key({ modkey, "Control" }, "Return", function () awful.util.spawn(browser_debug) end),
